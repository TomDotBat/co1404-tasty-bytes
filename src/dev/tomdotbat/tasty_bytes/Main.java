...
public class Main {
	public static void main(String[] args) { //Program entry point
		...
		MessageHandler.handleInput(""); //Run the main loop once before taking inputs
		while (MessageHandler.handleInput(reader.nextLine())); //Run the message handler until it returns false
